...
| Campo               | Valore                                           |
|---------------------|--------------------------------------------------|
| Task attivo          | **Nessuno** — **TASK-062** chiuso in `DONE`; **TASK-060** resta sospeso / `BLOCKED`; **TASK-055** resta `PARTIAL`; **TASK-063** resta `BACKLOG`. |
| Fase task attivo     | **N/A** — stato globale idle dopo chiusura TASK-062. |
...
> **Contesto:** follow-up a **TASK-055** ( **`PARTIAL`** ). **TASK-059** è **`DONE`**. **TASK-060** è **sospeso / `BLOCKED`** per decisione esplicita utente del 2026-04-26, con review non chiusa; **TASK-061** è **`DONE`** dal 2026-04-26 su conferma utente. **TASK-062** è **`DONE`** dal 2026-04-26 dopo review finale documentale. **TASK-063** resta in `BACKLOG` con descrizione sotto.
