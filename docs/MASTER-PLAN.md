...
**Nota 2026-04-11:** **TASK-047** — **`PLANNING`** / backlog `BACKLOG` — modernizzazione UX seconda onda su `GeneratedScreen` (file `docs/TASKS/TASK-047-generated-screen-ios-hierarchy-progress-summary.md`); **TASK-046** / **TASK-045** / **TASK-041** risultano **`DONE`** nel backlog aggiornato. Il paragrafo storico sotto resta come log.
...
| Campo               | Valore                                           |
|---------------------|--------------------------------------------------|
| Task attivo          | **TASK-047** — `REVIEW` (2026-04-11) |
| Fase task attivo     | REVIEW |
| Backlog documentale  | Audit UX/UI 2026-04-04 (TASK-030 → TASK-041); **TASK-030** `DONE`; **TASK-031** `DONE`; **TASK-032** `DONE`; **TASK-034** `DONE`; **TASK-035** `DONE`; **TASK-037** `DONE`; **TASK-038** `DONE` (review repo-grounded APPROVED senza fix, build/lint verdi, smoke execution e call site audit verificati 2026-04-05); **TASK-039** `DONE` (2026-04-05 — rollback esplicito al dialog precedente con preset + checkbox, review veloce positiva, build/lint verdi); **TASK-040** `DONE` (2026-04-05 — chiusura documentale; review repo-grounded + micro-fix FAB overlay; `assembleDebug` / `lint` / `ExcelViewModelTest` verdi; file `docs/TASKS/TASK-040-pregenerate-supplier-category-e-feedback-qualita.md`); **TASK-041** `DONE` (2026-04-11 — chiusura esplicita utente; review APPROVED; banner completamento + quick export `GeneratedScreen`; rischio residuo non bloccante: build/lint e smoke UI non eseguibili per limite JDK; file `docs/TASKS/TASK-041-completamento-workflow-celebrazione-quick-export.md`); **TASK-042** `DONE` (2026-04-04); **TASK-043** `DONE` (2026-04-10 — esclusione righe footer/totali da `dataRows`; review APPROVED; `docs/TASKS/TASK-043-robustezza-esclusione-righe-totali-footer-preview-import-analysis.md`); **TASK-044** `DONE` (2026-04-11 — History senza entry tecniche `APPLY_IMPORT_*` + `FULL_IMPORT_*`; review planner APPROVED repo-grounded; filtro centralizzato `USER_VISIBLE_HISTORY_WHERE_CLAUSE` DAO + stop insert VM + baseline JVM + build/lint verdi; file `docs/TASKS/TASK-044-history-cronologia-utente-senza-entry-tecniche-apply-import.md`); **TASK-045** `DONE` (2026-04-11); **TASK-046** `DONE` (2026-04-11 — PreGenerateScreen UX full iOS-style; file `docs/TASKS/TASK-046-pregenerate-ios-style-full-ux-rewrite.md`); **TASK-047** `ACTIVE` (2026-04-11 — GeneratedScreen gerarchia iOS-like: progress card, toggle errori, summary footer, top bar minimale; file `docs/TASKS/TASK-047-generated-screen-ios-hierarchy-progress-summary.md`; stato file task **REVIEW** — build/lint verdi, in attesa review planner) |
| Milestone            | **TASK-046** **`DONE`** (2026-04-11). **TASK-045** **`DONE`** (2026-04-11). **TASK-044** **`DONE`** (2026-04-11). **TASK-043** **`DONE`** (2026-04-10). **TASK-041** **`DONE`** (2026-04-11). **TASK-042** **`DONE`** (2026-04-04). **TASK-040** **`DONE`** (2026-04-05). **TASK-039** **`DONE`** (2026-04-05). **TASK-038** **`DONE`** (2026-04-05). **TASK-037** **`DONE`** (2026-04-05). **TASK-035** **`DONE`** (2026-04-05). **TASK-032** **`DONE`** (2026-04-05). **TASK-030** **`DONE`** (2026-04-04). **TASK-016** **`DONE`** (2026-04-05). **TASK-029** **`DONE`** (2026-04-03). **TASK-028** **`DONE`** (2026-04-03). **TASK-027** **`DONE`** (2026-04-03). **TASK-026** **`DONE`** (2026-04-03). **TASK-025** **`DONE`** (2026-04-03). **TASK-015** **`DONE`** (2026-04-03). **TASK-024** **`DONE`** (2026-03-30). **TASK-023** **`DONE`** (2026-03-30). **TASK-022** **`DONE`** (2026-03-30). **TASK-019** **`DONE`** (2026-03-30). **TASK-018** **`DONE`**. **TASK-014** **`DONE`**. **TASK-009** **`DONE`**. **TASK-021** **`DONE`**. **TASK-006** / **TASK-011** **`BLOCKED`**. **TASK-012** **`DONE`**. **TASK-010** **`DONE`**. **TASK-007** **`DONE`**. |
| Prossimo passo operativo | **TASK-047** in **REVIEW** — modernizzazione UX `GeneratedScreen`; build/lint verdi; smoke manuale su dispositivo/emulator raccomandato prima di approvare. |
| Ultimo aggiornamento | 2026-04-11 — **TASK-047** execution completata; build/lint verdi; portato in `REVIEW`. |
...
| Campo       | Valore                                                  |
|-------------|---------------------------------------------------------|
| Stato       | `BACKLOG` (file task **PLANNING**, 2026-04-11)          |
| Priorità    | `ALTA`                                                  |
