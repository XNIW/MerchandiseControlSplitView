...
**Nota 2026-04-25 (stato corrente):** **TASK-058** — **`DONE`** (2026-04-25 — review planner APPROVED senza fix; `assembleDebug` / `lintDebug` / `testDebugUnitTest` (mirati + full suite) verdi; override locale post-update + merge presentazionale + dialog re-sync confermati repo-grounded; remoto puntuale N/A motivato); file `docs/TASKS/TASK-058-database-screen-refresh-locale-scroll-stabile.md`. **Prossimo passo operativo:** in attesa indicazioni utente per prossimo task. **TASK-057** — **`DONE`** (2026-04-25).
...
| Campo               | Valore                                           |
|---------------------|--------------------------------------------------|
| Task attivo          | **Nessuno** — **TASK-058** chiuso `DONE` (2026-04-25 — review planner APPROVED senza fix). **TASK-057** resta chiuso `DONE` (2026-04-25). |
| Fase task attivo     | **DONE / TASK-058 completato** — in attesa indicazioni utente per prossimo task. |
