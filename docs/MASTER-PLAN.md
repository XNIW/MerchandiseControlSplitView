...
**Nota 2026-04-12:** **TASK-047** — **`DONE`** (2026-04-12) — modernizzazione UX seconda onda su `GeneratedScreen`: top bar minimale, progress card, toggle errori, griglia alleggerita; review planner FIX APPLIED → APPROVED; build/lint verdi. Nessun task attivo. Il paragrafo storico sotto resta come log.
