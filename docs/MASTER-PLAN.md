...
| Campo               | Valore                                           |
|---------------------|--------------------------------------------------|
| Task attivo          | Nessun task Android attivo |
| Fase task attivo     | **TASK-075 DONE** — review finale chiusa; `lintDebug` `0 errors, 3 warnings`, build/lint/test e smoke emulator verdi |
...
| Prossimo passo operativo | Nessun task Android attivo. I 3 warning residui (`OldTargetApi`, POI trust manager esterno) richiedono task dedicato/compat review o fix upstream. |
| Ultimo aggiornamento | 2026-05-28 — **TASK-075 DONE**: review finale completata; Supabase Kotlin `3.6.0` e Ktor `3.5.0` mantenuti su conferma utente; `lintDebug` ridotto a `0 errors, 3 warnings`; build/lint/test e smoke emulator verdi. |
